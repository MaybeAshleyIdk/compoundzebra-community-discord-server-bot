...
internal fun initializeDatabase(statement: Statement, logger: Logger) {
	...
	try {
		val dbInitSql: String =
			FileSystem.RESOURCES.read(DATABASE_INITIALIZATION_SQL_FILE_PATH, BufferedSource::readUtf8)
		...
		throw (if (e is Exception) DatabaseInitializationException(e) else e)
	}
