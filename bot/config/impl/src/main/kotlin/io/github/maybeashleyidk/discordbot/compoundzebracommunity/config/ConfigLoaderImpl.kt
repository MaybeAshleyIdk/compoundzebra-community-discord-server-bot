...
@Singleton
public class ConfigLoaderImpl @Suppress("ktlint:standard:annotation") @Inject internal constructor(
	...
	private fun updateCachedConfigUnsynchronized(): Config {
		val readConfig: ConfigFileManager.ReadFile<Config> =
			this.configFileManager.readFile { source: BufferedSource ->
				val configJson: ConfigJson? = this@ConfigLoaderImpl.configJsonAdapter.fromJson(source)
