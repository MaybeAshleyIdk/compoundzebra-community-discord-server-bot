...
@Singleton
internal class PollManager @Suppress("ktlint:standard:annotation") @Inject constructor(
	...
	sealed class CloseResult {
		...
		object WrongComponentId : CloseResult()
		object InsufficientPermissions : CloseResult()
	...
	fun voteOption(member: Member, optionsSelectMenuComponentId: String, optionValue: String): PollDetails? {
	...
	fun close(member: Member, closeButtonComponentId: String): CloseResult {
		@Suppress("RemoveRedundantQualifierName")
